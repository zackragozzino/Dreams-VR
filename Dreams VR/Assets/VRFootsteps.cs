...
public class VRFootsteps : MonoBehaviour {
	...
	private void GroundCheck()
	{
		...
		//		if (Physics.SphereCast(transform.position, m_Capsule.radius * (1.0f - 0.2f), Vector3.down, out hitInfo,
		//((m_Capsule.height / 2f) - m_Capsule.radius) + 0.2f, Physics.AllLayers, QueryTriggerInteraction.Ignore))
